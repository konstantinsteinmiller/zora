...
const elementToColorMpa: Record<Element, string> = {
  ...
  AIR: 'rgba(135, 206, 235, 0.19)', // Light blue, similar lightness
  WATER: 'rgba(65, 105, 225, 0.19)', // Medium blue, similar saturation
  ...
  EARTH: 'rgba(139, 69, 19, 0.19)', // Brown, lower lightness but same transparency
  ICE: 'rgb(80,193,221)', // Light blue, often associated with ice
  FIRE: 'rgba(255, 69, 0, 0.19)', // Orange-red, similar saturation
